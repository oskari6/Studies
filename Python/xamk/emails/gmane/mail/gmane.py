...
from urllib.parse import urlibjoin
from urllib.parse import urlparse
import re
from datetime import datetime, timedelta

#for faster files so dont have wait 5 hours for the spider (600mb below)
...
while True:
    ...
    try:
        ...
        print("")
        print("Program interrupted bu user...")
        break
    ...
    cur.execute("""INSERT OR IGNORE INTO Messages (id, email, sent_at, subject, headesr, body)

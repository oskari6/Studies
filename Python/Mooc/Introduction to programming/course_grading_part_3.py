...
def read_files(students_info, exercises_info, exam_point_info):
    students = {}
    exercise_points = {}
    exercise_sum = {}
    exam_points = {}
    ...
    for id, name in students.items():
        ...
        if total >= 0 and total <= 14:
            ...
            grade = 5
        print(f"{name:30}{exercise_sum.get(id, 0):<10}{exercise_points.get(id, 0):<10}{exam_points.get(id, 0):<10}{total:<10}{grade:<10}")
...
if True:
    ...
    read_files(student_info, exercise_data, exam_point_info)
else:
    # hard-coded input

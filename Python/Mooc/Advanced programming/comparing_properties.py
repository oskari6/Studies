...
class RealProperty:
    ...
    def price_difference(self, compared_to):
        diff = abs(self.square_metres * self.price_per_sqm - compared_to.square_metres * compared_to.price_per_sqm)
        return diff
    
    def more_expensive(self, compared_to):
        prop1 = self.square_metres * self.price_per_sqm
        prop2 = compared_to.square_metres * compared_to.price_per_sqm
        if prop1 > prop2:
            return True
        else:
            return False
